class TTT extends String {
    ...
    static toSnakeCase() {
        this.value = this.removeAccents().LowerCase().value.replaceAll(/\s+/g, "_");
        return this;
    }

    static toScreamingSnakeCase() {
        this.value = this.removeAccents().UpperCase().value.replaceAll(/\s+/g, "_");
        return this;
    }

    static toKebabCase() {
        this.value = this.removeAccents().LowerCase().value.replaceAll(/\s+/g, "-");
        return this;
    }

    static toTrainCase() {
        this.value = this.removeAccents().capitalize().value.replaceAll(/\s+/g, "-");
        return this;
    }

    static toCobolCase() {
        this.value = this.removeAccents().UpperCase().value.replaceAll(/\s+/g, "-");
        return this;
    }
}
